...
open class TrapeziumCreator: NSObject, ShapeCreator {
...
@_cdecl("trapezium_creator_init")

public func trapeziumCreatorInit() -> TrapeziumCreator {
    let creator = TrapeziumCreator()
    return creator
}
